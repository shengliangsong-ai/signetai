      ...
      <div className="space-y-8 animate-in fade-in duration-500">
        ...
        <div className="p-4 border-l-4 border-[var(--trust-blue)] bg-[var(--admonition-bg)]">
           <p className="text-xs font-serif italic opacity-80 leading-relaxed">
             "We do not just describe the protocol; we embody it. Navigate to <a href="/spec" className="underline font-bold text-[var(--trust-blue)]">signetai.io/spec</a> to interact with Signet-Alpha."
           </p>
        </div>
      </div>
    )
