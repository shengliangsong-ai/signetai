  ...
  },
  {
    ...
    content: (
      <div className="space-y-8 animate-in fade-in duration-500">
        ...
        <div className="mt-8">
           <h5 className="font-mono text-[10px] uppercase font-bold text-[var(--text-header)] mb-4">ISO/NIST Threat Model (v0.3.3)</h5>
    ...
    content: (
      <div className="space-y-8 animate-in fade-in duration-500">
        ...
        <p className="indent-12 opacity-80 leading-loose text-justify">
          The Signet Protocol (v0.3.3) defines a decentralized framework for the cryptographic attestation of AI-generated reasoning paths (VPR). 
