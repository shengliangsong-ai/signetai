  ...
  return (
    <div className="py-24 max-w-4xl mx-auto animate-in fade-in duration-700">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-20">
         <div className="p-10 bg-[var(--admonition-bg)] border border-[var(--trust-blue)] rounded-xl shadow-2xl flex flex-col justify-between min-h-[300px]">
            <div>
            ...
            <a 
                ...
                target="_blank" 
                rel="noreferrer"
                className="w-full py-4 bg-[var(--trust-blue)] text-white font-mono text-xs uppercase font-bold tracking-[0.3em] rounded text-center hover:brightness-110 transition-colors"
            >
                Become a Sponsor
            </a>
         </div>
