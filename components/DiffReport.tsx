...
const mockAnalysisResult = {
  ...
  samplesA: [
    { index: 1, t_sec: 0, p_hash_64: 'a3f4c1b9a8e7d6c5', d_hash_64: 'ff00ff00ff00ff00', preview_jpeg_data_url: 'https://via.placeholder.com/150/0000FF/FFFFFF?text=Source+A-1', capture_status: 'OK', frame_size: '1920x1080' },
    { index: 2, t_sec: 30, p_hash_64: 'b9c1d8e7f6a5b4c3', d_hash_64: 'ffff0000ffff0000', preview_jpeg_data_url: 'https://via.placeholder.com/150/0000FF/FFFFFF?text=Source+A-2', capture_status: 'OK', frame_size: '1920x1080' },
    { index: 3, t_sec: 60, p_hash_64: 'f0a9b8c7d6e5f4a3', d_hash_64: '0000ffff0000ffff', preview_jpeg_data_url: 'https://via.placeholder.com/150/0000FF/FFFFFF?text=Source+A-3', capture_status: 'OK', frame_size: '1920x1080' },
    { index: 4, t_sec: 90, p_hash_64: 'cce3d2a1b0c9d8e7', d_hash_64: 'ff0000ffffff0000', preview_jpeg_data_url: 'https://via.placeholder.com/150/0000FF/FFFFFF?text=Source+A-4', capture_status: 'OK', frame_size: '1920x1080' },
  ],
  samplesB: [
    { index: 1, t_sec: 0, p_hash_64: 'a3f4c1b9a8e7d6c5', d_hash_64: 'ff00ff00ff00ff00', preview_jpeg_data_url: 'https://via.placeholder.com/150/FF0000/FFFFFF?text=Source+B-1', capture_status: 'OK', frame_size: '1920x1080' },
    { index: 2, t_sec: 30, p_hash_64: 'b9c1d8e7f6a5b4c3', d_hash_64: 'ffff0000ffff0000', preview_jpeg_data_url: 'https://via.placeholder.com/150/FF0000/FFFFFF?text=Source+B-2', capture_status: 'OK', frame_size: '1920x1080' },
    { index: 3, t_sec: 60, p_hash_64: 'd8b3a9f0c7b8d6e5', d_hash_64: '0000ffff0000ffff', preview_jpeg_data_url: 'https://via.placeholder.com/150/FF0000/FFFFFF?text=Source+B-3', capture_status: 'OK', frame_size: '1920x1080' },
    { index: 4, t_sec: 90, p_hash_64: 'cce3d2a1b0c9d8e7', d_hash_64: 'ff0000ffffff0000', preview_jpeg_data_url: 'https://via.placeholder.com/150/FF0000/FFFFFF?text=Source+B-4', capture_status: 'OK', frame_size: '1920x1080' },
  ],
};
            ...
            {samplesA.map((sampleA, i) => {
              ...
              return (
                <tr key={sampleA.index} className="hover:bg-gray-800/30">
                  ...
                  <td className="p-3"><img src={sampleA.preview_jpeg_data_url} alt={`Source A Frame ${sampleA.index}`} className="w-32 h-20 object-cover rounded-md border border-blue-500/50" /></td>
                  <td className="p-3"><img src={sampleB.preview_jpeg_data_url} alt={`Source B Frame ${sampleB.index}`} className="w-32 h-20 object-cover rounded-md border border-red-500/50" /></td>
